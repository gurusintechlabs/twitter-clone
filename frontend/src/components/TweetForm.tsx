...
const TweetForm: React.FC<TweetFormProps> = ({ onNewTweet }) => {
  ...
  return (
    <div className="border-b border-twitter-extra-light p-4">
      {error && (
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between border-t border-twitter-extra-light pt-4">
              <div className="flex">
                <button
                  type="button"
                  className="text-twitter-blue p-2 rounded-full hover:bg-blue-50"
                >
              ...
              <div className="flex items-center">
                ...
                <button
                  ...
                  className="bg-twitter-blue text-white px-4 py-2 rounded-full font-bold hover:bg-blue-600 transition-colors disabled:opacity-50"
                >
